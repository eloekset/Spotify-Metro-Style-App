...
using Spotify.MetroStyle.XamlTypeInfo;
...
namespace Spotify.MetroStyle.XamlTypeInfo
{
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object Activate_0_SearchPage() { return new Spotify.MetroStyle.View.SearchPage(); }


        private object Activate_1_CollectionPage() { return new Spotify.MetroStyle.CollectionPage(); }


        private object Activate_2_SplitPage() { return new Spotify.MetroStyle.SplitPage(); }
        ...
        private IXamlType CreateXamlType(string typeName)
        {
            ...
            case "Spotify.MetroStyle.View.SearchPage":
                userType = new XamlUserType(this, typeName, typeof(Spotify.MetroStyle.View.SearchPage), GetXamlTypeByName("Windows.UI.Xaml.Controls.UserControl"));
                userType.Activator = Activate_0_SearchPage;
                xamlType = userType;
                break;
            case "Spotify.MetroStyle.CollectionPage":
                userType = new XamlUserType(this, typeName, typeof(Spotify.MetroStyle.CollectionPage), GetXamlTypeByName("Windows.UI.Xaml.Controls.UserControl"));
                userType.Activator = Activate_1_CollectionPage;
                xamlType = userType;
                break;
            case "Spotify.MetroStyle.SplitPage":
                userType = new XamlUserType(this, typeName, typeof(Spotify.MetroStyle.SplitPage), GetXamlTypeByName("Windows.UI.Xaml.Controls.UserControl"));
